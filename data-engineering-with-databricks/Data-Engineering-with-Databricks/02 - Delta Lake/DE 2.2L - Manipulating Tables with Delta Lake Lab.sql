...
CREATE TABLE IF NOT EXISTS beans(name STRING, color STRING, grams FLOAT, delicious BOOLEAN);
...
WHEN MATCHED THEN UPDATE SET grams = n.grams + o.grams
WHEN NOT MATCHED AND n.delicious = 'true' THEN INSERT *
